  ...
  style="background-color: var(--contrast); 
    ...
    <div data-aos="zoom-in">
      <h1 class="text-5xl font-bold mb-6">
        <span style="color: var(--primary-bg);">Cari Lawan Tanding Dan Jadwal Olahraga Dengan Mudah</span>
      </h1>
...
<div class=" flex items-center justify-center text-center px-4">
  ...
  <p class="text-blue-700 text-center mt-4">
                ...
                <div class="footer__title-left">
                    <h2><span>Apply for partnership</span>
                        ...
                        <div class="footer__title-right">
                            <a class="btn btn_dark animated btn_lite btn_single" href="https://forms.gle/3ndkykxdJquxiVvg6" targe="_blank" data-hover="Apply"><span>Apply</span></a>
                        </div>
                    </div>
                    <div class="footer__map">
                    <div class="footer__left">
                            <img src="{{ asset('img/logo.png') }}" alt="sportmatch">
